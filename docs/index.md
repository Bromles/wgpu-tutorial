...
сильно устарел и не рекомендуется для новых разработок, данный ресурс остается самым подробным руководством для новичков
в графике и объясняет на примерах типовые проблемы и решения. Стоит внимания для понимания общих концепций CG вне
зависимости от используемого API.
