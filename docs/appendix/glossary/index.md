...
индексам).
См. [Вершинные и индексные буферы](/guide/gpu-data-model/buffers/).
...
и т.д.). См. [Вершинные и индексные буферы](/guide/gpu-data-model/buffers/).

**Индексный буфер (index buffer)** — массив целых чисел, ссылающихся на позиции вершин в вершинном буфере; устраняет
дублирование общих вершин. См. [Вершинные и индексные буферы](/guide/gpu-data-model/buffers/).
