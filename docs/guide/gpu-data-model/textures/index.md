...
UV (0, 0) — левый верхний угол текстуры, (1, 1) — правый нижний.
...
Текстура — «сырая» память, а texture view описывает, как её интерпретировать. View может выбирать конкретный
mip-уровень, диапазон слоёв массива или переинтерпретировать формат. Для нашего случая подходит default view — он
охватывает всю текстуру целиком.
