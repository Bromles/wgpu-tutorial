...
<img src="/diagrams/pipeline-layout-bind-groups.svg" alt="Pipeline Layout, Bind Group Layouts и Bind Groups" style="width: 100%;" />
...
16 КБ (`max_uniform_buffer_binding_size`), хотя адаптер может поддерживать до 256 МБ. Для массивов текстур,
