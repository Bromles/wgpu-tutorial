...
Рекомендуется передавать его в разные части программы для переиспользования вместо постоянного создания новых прогонов, 
где это возможно.
...
должны создавать свои собственные буферы команд, и передавать их в один поток для разового исполнения, вместо множества 
вызовов метода отправки.
