...
Это далеко не полная схема устройства библиотеки, поскольку она была бы слишком запутанной на данном этапе. Лишь
несколько ключевых компонентов, необходимых нам на данный момент
