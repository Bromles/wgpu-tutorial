...
окном приложения откроется еще отдельное окно консоли. Для предотвращения подобного поведения в релизной сборке, нужно 
добавить следующую строчку в самый верх файла, содержащего нашу* `main` *функцию:* 
