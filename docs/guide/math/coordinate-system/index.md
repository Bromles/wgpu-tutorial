...
$$
\vec{p}_{clip} \approx (6.4,\ 1.6,\ 9.9,\ 10.0)
$$

**4. Clip → NDC** (перспективное деление):

$$
\text{ndc}_x = \frac{6.4}{10} = 0.64, \quad
\text{ndc}_y = \frac{1.6}{10} = 0.16, \quad
...
$$
\text{pixel}_x = \frac{0.64 + 1}{2} \cdot 800 = 656, \quad
\text{pixel}_y = \frac{1 - 0.16}{2} \cdot 600 = 252
$$

Вершина отобразится в пиксель $(656, 252)$ — правая часть окна, ближе к верху.
